...
const ShopContent = ({ products = [] }) => { // Thêm default value là mảng rỗng []
  // Tạo một hằng số an toàn để filter không bao giờ sập
        ...
        <div key={idx} className="bg-white p-6 rounded-[2rem] border-2 border-black shadow-sm italic">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {item.packages.map((pkg, i) => {
              ...
              // SỬA TẠI ĐÂY: Dùng safeProducts thay vì products trực tiếp
